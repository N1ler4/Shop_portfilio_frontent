...
const VerticalPage: React.FC = () => {
  ...
  return (
    ...
    >
      ...
      {/* Main content */}
      <div className="flex flex-row items-end w-full max-w-full justify-center mt-20">
        {/* Описание и автор — только на ПК */}
        <div className="hidden lg:flex flex-col justify-end min-w-[260px] max-w-[300px] h-full mr-6 pb-0" style={{height: '100%'}}>
        ...
        {/* Объявление */}
        <div
          className="relative flex flex-col items-center justify-center h-full w-full max-w-[330px] mx-auto lg:static lg:max-w-[330px] lg:h-full lg:bg-transparent lg:rounded-2xl lg:shadow-2xl"
          onWheel={(e) => {
